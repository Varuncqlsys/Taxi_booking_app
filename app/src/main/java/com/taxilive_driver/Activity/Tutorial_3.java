...
public class Tutorial_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vertification_3);
        ...
        next_lay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in = new Intent(Tutorial_3.this, Login_Activity.class);
                startActivity(in);
                finish();
            }
        });
        ...
        pre_lay.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent in = new Intent(Tutorial_3.this, Tutorial_2.class);
                startActivity(in);
                finish();
            }
        });
